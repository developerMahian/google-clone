...
const reactPaginateBtnClasses = "inline-block px-5 py-1.5 bg-gray-200 dark:bg-gray-700 hover:scale-90 transition-transform rounded-lg font-bold cursor-pointer";

const paginateIconClass = "text-lg p-1.5 text-sky-500 bg-gray-300 dark:bg-gray-700 rounded-full hover:scale-90 transition-transform cursor-pointer";
